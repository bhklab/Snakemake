...
if (opt$remove_centromeres){
 cent <- read.table("/cluster/projects/bhklab/Data/biobank_merged_RNAseq/Sequenza/ucsc_hg19_centromeres_txt.txt",
            sep = "\t", header = F)
...
load(file="/cluster/projects/bhklab/Data/biobank_merged_RNAseq/Sequenza/PANCAN_ASCAT_ploidy_prob.Rdata")
